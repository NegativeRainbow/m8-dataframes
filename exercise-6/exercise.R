...
setwd('C:/Users/Danish/Documents/CSE/INFO201/m8-dataframes/exercise-6')
...
MostPopular <- function(my.year){
  ...
  most.pop.name.year <- names.year[prop.year == max(prop.year)]
  return(paste('The most popular female baby name in', my.year, 'was', most.pop.name.year))
}
