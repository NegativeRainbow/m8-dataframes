...
salaries2014 <- runif(100, 0, 1000000)

# Create a vector of 2015 salaries that are typically higher than the 2014 salaires (use runif again)
salaries2015 <- runif(100, 100000, 2000000)

# Create a data.frame 'salaries' by combining the vectors you just made
salaries <- data.frame(employees=employees, salaries2014=salaries2014, salaries2015=salaries2015)
...
employee57.salary <- salaries$salaries2015[[57]]
...
employee.highestraise <- salaries[employees, raise == highest.raise]
